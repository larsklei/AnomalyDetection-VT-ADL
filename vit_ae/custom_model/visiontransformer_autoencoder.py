...
class VisionTransformerAutoencoder(keras.Model):
	...
	@tf.function
	def compute_ssim_value(self, images, reconstructions):
		...
		return 1 - ssim(ground_truths, masks, max_val=1)
	...
	def train_step(self, data):
		...
		ssim_value = self.compute_ssim_value(images, reconstructions)
